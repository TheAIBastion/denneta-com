...
<p class="post-meta">2026-06-29</p>
...
ここで重要なのは、この損失が**事前に測定可能**だということだ。純正五度は701.955セントであり、平均律の五度は700セント。その差は正確に1.955セントである。調律する前に、何をどれだけ失うかが分かっている。損失関数が定義されており、その値を計算できる。
